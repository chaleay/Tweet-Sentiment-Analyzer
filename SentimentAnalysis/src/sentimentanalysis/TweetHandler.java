...
public class TweetHandler implements TweetHandlerInterface {
           ...
           // logger.log(Level.INFO, "Reading from file: " + filePath);
            if (!file.exists()) {
               ...
               // logger.log(Level.SEVERE, "File does not exist.");
                ...
                //logger.log(Level.INFO, "File opened and read succesfully");
                return tempList;
            }
     ...
     */
    public ArrayList<AbstractTweet> searchByUser(String user) {
        ArrayList<AbstractTweet> resultList = new ArrayList<AbstractTweet>();
     ...
     * @return A list of tweet objects.
     */
    public ArrayList<AbstractTweet> searchByDate(Date date) {
        ArrayList<AbstractTweet> result_List = new ArrayList<AbstractTweet>();
     ...
     * @return A list of tweet objects.
     */
    public ArrayList<AbstractTweet> searchByFlag(String flag) {
        ArrayList<AbstractTweet> resultList = new ArrayList<AbstractTweet>();
     ...
     * @return A list of tweet objects.
     */
    public ArrayList<AbstractTweet> searchBySubstring(String substring) {
        ArrayList<AbstractTweet> resultList = new ArrayList<AbstractTweet>();
